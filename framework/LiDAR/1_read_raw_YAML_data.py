...
for Lidar data timestaps without XYZD data will be copied
...
def Frame_Counter(Frame_Info, Global_Time):
...
def read_yaml(dirs, frames_dir, out):
                ...
                for shot in shots:  
                    ...
                    if len(shot)>3:
                        ...
                        if YAML_Image_names[-1] in Image_names:
                            ...
                            move_images(counter, frames_dir, YAML_Image_names[-1], DeviceNames[-1], Video_Flow,
                            ...
                            time_photo_and_lidar = datetime.fromtimestamp(velodyneLidar_grabMsec/1e6 +
